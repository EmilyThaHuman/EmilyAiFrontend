              ...
              <HoverCard>
                <HoverCardTrigger
                  className={classNames(
                    ...
                    {
                      'text-block border-sky-500 hover:border-sky-500':
                        index === currentVersion,
                      'hover:border-slate-900 border-slate-300 ':
                        index !== currentVersion,
                    }
                  )}
                  onClick={() =>
                ...
                >
                  {' '}
                  <div
                    className="bg-[length:160px_100px] bg-no-repeat bg-center w-full h-[80px]"
                    style={{
                ...
                <HoverCardContent>
                  <div>
                    {item.type === 'ai_edit'
                      ? item.inputs.originMessage || item.inputs.prompt
                      : 'Create'}
                  </div>
                </HoverCardContent>
              </HoverCard>
