...
const templateData = [
  ...
  },
  {
    ...
    route: `${base}/admin/workspaces`,
    link: `${base}/admin/workspaces`,
    a: `${host}/admin/workspaces`,
  },
  {
    id: uniqueId('chat-'),
    type: 'template',
    ...
    icon: <ChatIcon sx={{ width: 20, height: 20, color: 'inherit' }} />,
    path: '/chat',
    route: `${base}/admin/workspaces/:workspaceId/chat`,
    link: `${base}/admin/workspaces/:workspaceId/chat`,
  },
  {
    id: uniqueId('auth-'),
    title: 'Sign In',
