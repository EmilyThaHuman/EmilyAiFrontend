...
import { ArtifactMessagePartData, parseMessage } from '@/lib/utils';
import { BotIcon, CodeIcon, Loader2Icon, UserIcon } from 'lucide-react';

const getDisplayNameFromRole = (role, model) => {
...
export function ChatMessage({ role, text, attachments, setCurrentArtifact }) {
  return (
    <div
...
function MessagePart({ data, setCurrentArtifact }) {
